...
public class Text{
	...
	public static int hexDigitToInt(char d){
		if(d > 'f') throw new Err("Not a hex digit["+d+"]"); //some chars would wrap and match a digit
	...
	public static int hexDigitToInt(byte d){
		...
		throw new Err("Not a hex digit: (baseTen)"+d);
	}
	...
	*/
	public static List<String> parseNaturalLanguageAndSymbolsUrlsAndNumbers(String s){
		...
		int lastUrlEnd = 0;
		for(humanaicore.common.IntRange urlRange : findURLs(s)){
    ...
    */
	public static String[] lines(String s){
		...
		try{
			...
			throw new Err(e); //StringReader wont do this
		}
